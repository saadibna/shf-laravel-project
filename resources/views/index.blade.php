...
<section>
        <div class="swiper-container swiper-slider swiper-variant-1 bg-black" data-loop="false" data-autoplay="5500" data-simulate-touch="true">
          <div class="swiper-wrapper text-center">
            <div class="swiper-slide" data-slide-bg="{{asset('frontend')}}/assets/images/home-slider-1.jpg">
...
<section class="bg-displaced-wrap">
          ...
          <div class="container">
            <div class="inset-xl-left-70 inset-xl-right-70">
              <article class="box-cart bg-ebony-clay">
                <div class="box-cart-image"><img src="{{asset('frontend')}}/assets/images/about-us.jpg" alt="" width="342" height="338"/>
                </div>
        ...
        <div class="bg-displaced bg-image" style="background-image: url({{asset('frontend')}}/assets/images/counter.jpg);"></div>
      </section>
      ...
      <!-- Counter section -->
<section class="section parallax-container bg-black" data-parallax-img="{{asset('frontend')}}/assets/images/happy.jpg">
          ...
          <div class="row row-40 row-offset-1 justify-content-sm-center justify-content-md-start">
            <div class="col-sm-9 col-md-6 col-lg-4 col-xl-3">
              <article class="post-boxed">
                <div class="post-boxed-image"><img src="{{asset('frontend')}}/assets/images/home-5-268x182.jpg" alt="" width="268" height="182"/>
                </div>
            ...
            <div class="col-sm-9 col-md-6 col-lg-4 col-xl-3">
              <article class="post-boxed">
                <div class="post-boxed-image"><img src="{{asset('frontend')}}/assets/images/home-6-268x182.jpg" alt="" width="268" height="182"/>
                </div>
                <div class="post-boxed-body">
            ...
            <div class="col-sm-9 col-md-6 col-lg-4 col-xl-3">
              <article class="post-boxed">
                <div class="post-boxed-image"><img src="{{asset('frontend')}}/assets/images/home-7-268x182.jpg" alt="" width="268" height="182"/>
                </div>
                <div class="post-boxed-body">
            ...
            <div class="col-sm-9 col-md-6 col-lg-4 col-xl-3">
              <article class="post-boxed">
                <div class="post-boxed-image"><img src="{{asset('frontend')}}/assets/images/home-8-268x182.jpg" alt="" width="268" height="182"/>
                </div>
                <div class="post-boxed-body">
